...
"}")
        ...
        self.CreateStartedLink_CheckBoc.setGeometry(QtCore.QRect(20, 90, 111, 16))
        font = QtGui.QFont()
        font.setFamily("有爱魔兽圆体 CN Medium")
        font.setPointSize(9)
        ...
        self.CreateDesktopLink_CheckBox.setGeometry(QtCore.QRect(160, 90, 141, 16))
        font = QtGui.QFont()
        font.setFamily("有爱魔兽圆体 CN Medium")
        font.setPointSize(9)
...
"}")
    ...
    def retranslateUi(self, installer):
        ...
        self.CreateStartedLink_CheckBoc.setText(_translate("installer", "创建 桌面 快捷方式"))
        self.CreateDesktopLink_CheckBox.setText(_translate("installer", "创建 开始 快捷方式"))
