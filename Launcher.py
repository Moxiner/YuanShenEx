...
def main():
    ...
    # 绘制控件
    mihoyo_button = tk.Button(Window_frame1 , text="启动官服",width=23 , command=mihoyo ,height=40 ,background="#FFCB20" ,bd=0 ,activebackground="#d2a617" ,font=("微软雅黑",12,"bold"  ) , fg="#89601A")
    bilibili_button = tk.Button(Window_frame1 , text="启动B服",width=23 ,command=bilibili ,height=40 , background="#FFCB20" , bd=0 ,activebackground="#d2a617", font=("微软雅黑",12,"bold" ) , fg="#89601A")
    fixbug_button = tk.Button(Window_frame2 , text="一键修复",width=47 ,command=fixbug ,height=40 , background="#efefef" , bd=0 ,activebackground="#9d9d9d", font=("微软雅黑",12,"bold" ))
